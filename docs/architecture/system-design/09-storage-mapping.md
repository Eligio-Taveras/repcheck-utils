...
| Q&A | AlloyDB | `qa_questions`, `qa_question_topics`, `qa_answer_options`, `qa_user_responses` | Survey/questionnaire questions, topic mappings, answer choices, and user responses |
