<!-- GENERATED FILE — DO NOT EDIT. Source: docs/architecture/scala-code-patterns/10-pubsub.md -->
...
- Only emit events with downstream consumers (see SYSTEM_DESIGN.md event catalog)
