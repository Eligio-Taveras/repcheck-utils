<!-- GENERATED FILE — DO NOT EDIT. Source: docs/architecture/scala-code-patterns/17-compile-enforcement.md -->

# 18. Compile-Time Enforcement

Tools that enforce patterns at compile time; violations fail the build.
